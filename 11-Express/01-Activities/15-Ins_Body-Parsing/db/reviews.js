...
const reviews = [
    {
        ...
        switch_type: 'Topre',
        username: 'kbdfan05',
        review: 'Love it! They typing feel is amazing but it lacks dedicated arrow keys',
        rating: 8,
        upvotes: 20,
        review_id: uuid(),
    },
    {
        ...
        username: 'TimApple',
        review: 'It works for what I need it for, but the travel distance is almost non-existent',
        rating: 6,
        upvotes: 20,
        review_id: uuid(),
    },
    {
        ...
        username: 'C00lcat',
        review: 'Great 60% keyboard with amazing build quality. Nice bang for your buck',
        rating: 9,
        upvotes: 20,
        review_id: uuid(),
    },
